          ...
          <Reveal key={work.slug} delay={i * 0.06}>
            <Link to={`/work/${work.slug}`} className="block">
              <motion.article
                ...
                className="overflow-hidden rounded-[28px] bg-ink p-3 sm:p-4"
              >
                ...
                <div className="px-2 pt-5 pb-2">
                  <h3 className="font-serif text-[32px] leading-none tracking-[-0.02em] text-[#ebebeb]">
                    {work.name}
                  </h3>
                  <p className="mt-2 text-[14px] font-medium tracking-[-0.01em] text-[#ebebeb]">
                    {work.tags.join("  ·  ")}
                  </p>
                  <p className="mt-2 max-w-[52ch] text-[14px] leading-relaxed text-[#ebebeb]/50">
                    {work.blurb}
                  </p>
                </div>
              </motion.article>
